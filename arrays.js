...
const year =  [1984, 1992, 2020, 2023];
console.log(year);
...
const ingredientsPasta = ['bladerdeeg', 'knoflook', 'spinazie'];
ingredientsPasta [0] = 'lasagnebladen';
console.log(ingredientsPasta);
console.log(ingredientsPasta.length);